    ...
    หรือทุกวัน :
 							      	...
 							      	<div  style="padding-left:20px;padding-bottom: 5px">
  	 									<table border="0">
  	 										...
  	 										<tr valign="bottom">
  	 										<td width="100px">
  	 										<input type="checkbox" name="billing_schedule_2" value="MonW5">&nbsp;&nbsp;จันทร์W5
  	 										</td>
  	 										<td  width="100px">
  	 										<input type="checkbox" name="billing_schedule_2" value="TueW5">&nbsp;&nbsp;อังคารW5
  	 										</td>
  	 										<td width="100px">
  	 										<input type="checkbox" name="billing_schedule_2" value="WedW5">&nbsp;&nbsp;พุธW5
  	 										</td>
  	 										<td  width="100px">
  	 										<input type="checkbox" name="billing_schedule_2" value="ThuW5">&nbsp;&nbsp;พฤหัสW5
  	 										</td>
  	 										<td width="100px">
  	 										<input type="checkbox" name="billing_schedule_2" value="FriW5">&nbsp;&nbsp;ศุกร์W5
  	 										</td>
  	 										<td width="100px">
  	 										<input type="checkbox" name="billing_schedule_2" value="SatW5">&nbsp;&nbsp;เสาร์W5
  	 										</td>
  	 										<td  width="100px">
    ...
    หรือทุกวัน :
 							      	...
 							      	<div  style="padding-left:20px;padding-bottom: 5px">
  	 									<table border="0">
  	 										...
  	 										<tr valign="bottom">
  	 										<td width="100px">
  	 										<input type="checkbox" name="payment_schedule_2" value="MonW5">&nbsp;&nbsp;จันทร์W5
  	 										</td>
  	 										<td  width="100px">
  	 										<input type="checkbox" name="payment_schedule_2" value="TueW5">&nbsp;&nbsp;อังคารW5
  	 										</td>
  	 										<td width="100px">
  	 										<input type="checkbox" name="payment_schedule_2" value="WedW5">&nbsp;&nbsp;พุธW5
  	 										</td>
  	 										<td  width="100px">
  	 										<input type="checkbox" name="payment_schedule_2" value="ThuW5">&nbsp;&nbsp;พฤหัสW5
  	 										</td>
  	 										<td width="100px">
  	 										<input type="checkbox" name="payment_schedule_2" value="FriW5">&nbsp;&nbsp;ศุกร์W5
  	 										</td>
  	 										<td width="100px">
  	 										<input type="checkbox" name="payment_schedule_2" value="SatW5">&nbsp;&nbsp;เสาร์W5
  	 										</td>
  	 										<td  width="100px">
