...
CREATE TABLE `ar_bill` (
  ...
  `customer_no` varchar(50) character set utf8 NOT NULL,
  ...
  `bill_status` varchar(25) character set utf8 NOT NULL,
  `bill_remark` varchar(50) character set utf8 NOT NULL,
